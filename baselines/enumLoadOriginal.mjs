...
if (process.argv[2]) {
  ...
  pkg = {
    ...
    // package_name: "insane",
    // version: "2.6.2",
    // pkgPath: "/home/benchmark/npm47k/insane-2.6.2/",
...
(async () => {
  ...
  try {
    ...
    fnList = fnEnumerate2(importedPkg, "pkgMainFunc", 6); //we add one level to include our cjs/mjs synthetic label
